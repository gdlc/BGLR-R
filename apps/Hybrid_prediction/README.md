...
For illustrative purposes we consider the maize dataset described in [Covarrubias-Pazaran, 2016](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0156744), and included in the ``sommer package'' briefly the dataset contains phenotypic data for plant 
